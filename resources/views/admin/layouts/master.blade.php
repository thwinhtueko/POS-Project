                    ...
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li>
                            <a href="{{ route('product#list') }}">
                                <i class="fa-solid fa-list-ol"></i>Product</a>
                        </li>
                        <li>
                            <a href="{{ route('order#home') }}">
                                <i class="fa-solid fa-arrow-up-9-1"></i>Order</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="{{ route('admin#contact') }}">
                                <i class="fa-solid fa-user-group"></i>Contact</a>
                        </li>
                    </ul>
                </nav>
            </div>
                            ...
                            <div class="col-5 text-center py-5">
                                @if (session('deleteSuccess'))
                                    <div class="alert alert-danger alert-dismissible fade show" role="alert">
                                        <i class="fa-solid fa-triangle-exclamation me-2 text-danger"></i><strong>
                                        ...
                                        <div class="account-dropdown js-dropdown">
                                            ...
                                            <div class="account-dropdown__footer">
                                                <form action="{{ route('logout') }}" method="POST">
                                                    @csrf
                                                    <button type="submit"
                                                        class="col-10 offset-1 btn btn-light p-2 mt-2 mb-3 offset-1 text-black-50 text-center">
